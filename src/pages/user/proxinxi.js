  ...
  return (
    <div className={styles.normal}>
      ...
      <div style={{ width: "300px", margin: "auto" }}>
        ...
        />
        {/* <label>商品ID</label>
        <Input placeholder="商品ID"  style={{marginTop:"20px",height:"45px"}} value={value1} ref={(val)=>value=val} onChange={()=>{console.log(value)}}/>
        <label>商品名</label>
        <Input placeholder="商品名"  style={{marginTop:"20px",height:"45px"}}  value={value2}/>
        <label>商品详情</label>
        <Input placeholder="商品详情"  style={{marginTop:"20px",height:"45px"}} value={value3}/>
        <label>商品价格</label>
        <Input placeholder="商品价格"  style={{marginTop:"20px",height:"45px"}} value={value4}/>
        <label>商品库存</label>
        <Input placeholder="商品库存"  style={{marginTop:"20px",height:"45px"}} value={value5}/>
          ...
          // if (props.proxinxi == null) {
            api.modifypro(value1, localStorage.getItem('token'), {
              ...
              if (data.status == 200) {
                ...
                window.location.href = "/user/proxinxi"
              }
            })
          // }
        }}>修改</Button>
...
export default connect(state => state.proxinxi)(Index)
